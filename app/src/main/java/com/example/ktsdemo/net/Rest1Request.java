 ...
 * Desc: restful方式请求
 */
public class Rest1Request<T> extends Request<T> {

    private final Map<String, ?> params;

    private Gson gson = new Gson();

    public Rest1Request(Class<T> generalClass, HttpMethod method, Map<String, ?> params, String url, HttpListener<T> listener) {
