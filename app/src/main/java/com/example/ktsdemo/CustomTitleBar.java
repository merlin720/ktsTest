...
public class CustomTitleBar extends RelativeLayout implements View.OnClickListener {
    ...
    private void initView(TypedArray array) {
        ...
        rootView = (RelativeLayout) findViewById(R.id.title_layout);
        ...
        leftTextSize =
            array.getDimension(R.styleable.CustomTitleBar_leftTextSize, SizeUtils.dp2px(15));
        rightTextSize =
            array.getDimension(R.styleable.CustomTitleBar_rightTextSize, SizeUtils.dp2px(17));
        middleTextSize =
            array.getDimension(R.styleable.CustomTitleBar_middleTextSize, SizeUtils.dp2px(15));
    ...
    public void setMiddleTitle(String title, boolean haveLeft) {
        if (haveLeft) {
            this.setLeftImage(R.drawable.left_arrow);
        }
        tvMiddle.setText(title);
    }

    public void setMiddleTitle(SpannableString title) {
        tvMiddle.setText(title);
    }
    ...
    public void setMiddleTitleImage(@StringRes int titleId, @DrawableRes int resId) {
        ...
        if (-1 != resId) {
            ...
            tvMiddle.setCompoundDrawablePadding(SizeUtils.dp2px(8));
  ...
  public void setLeftImage(@DrawableRes int leftImage) {
    ...
    if (-1 != leftImage) {
      ...
      drawable.setBounds(0, 0, drawable.getMinimumWidth(), drawable.getMinimumHeight());
      tvLeft.setCompoundDrawablePadding(SizeUtils.dp2px(8));
  ...
  public void setLeftImage(@DrawableRes int leftImage, int  maginLeft) {
    ...
    public void setRightImage(int rightImage) {
        setRightTitle(rightTitle);
        Drawable drawable = ContextCompat.getDrawable(getContext(), rightImage);
        drawable.setBounds(0, 0, drawable.getMinimumWidth(), drawable.getMinimumHeight());
        tvRight.setCompoundDrawablePadding(SizeUtils.dp2px(8));
